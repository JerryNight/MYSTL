...
// 该头文件用于类型萃取，且定义了三个萃取模版：__type_tarits  __is_integer  __char_type
...
struct __type_traits
{
    ...
    typedef __false_type    is_POD_type;             // Plain Old Data  纯旧式数据类型
};
...
struct __type_traits<bool>
{
    ...
    typedef __true_type    is_POD_type;             // Plain Old Data  纯旧式数据类型
};
