...
// min重载：使用传入的比较器
template<class T, class Compare>
inline const T& min(T& lhs, T& rhs, Compare comp)
{
    return comp(lhs, rhs) ? lhs : rhs;
}
...
inline void swap(ForwardIterator1 a, ForwardIterator2 b)
{
    mystl::swap(*a,*b);
}

// copy: input_iterator_tag
...
// copy: random_access_iterator_tag
template <class RandomAccessIterator, class OutputIterator>
inline OutputIterator __copy_d(RandomAccessIterator first, RandomAccessIterator last, OutputIterator result, random_access_iterator_tag)
{
...
// copy: 指针对象：指针对象是 random access iterator
template <class T>
...
inline pair<InputIterator, OutputIterator> __copy_n(InputIterator first, Size n,OutputIterator result, input_iterator_tag) 
{
...
template <class InputIterator, class Size, class OutputIterator>
inline pair<InputIterator, OutputIterator> __copy_n(InputIterator first, Size n,OutputIterator result, random_access_iterator_tag) 
{
    auto last = first + n;
...
inline bool equal(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2,Compared comp) 
{
    for (; first1 != last1; ++first1, ++first2) 
    {
...
bool lexicographical_compare(InputIterator1 first1, InputIterator1 last1,InputIterator2 first2, InputIterator2 last2) 
{
    ...
    return first1 == last1 && first2 != last2;  // 情况(2) 只有第一序列先结束，返回true，其余情况返回false
}

// 重载版本使用函数对象 comp 代替比较操作
template <class InputIterator1, class InputIterator2, class Compred>
bool lexicographical_compare(InputIterator1 first1, InputIterator1 last1,InputIterator2 first2, InputIterator2 last2, Compred comp) 
{
    for (; first1 != last1 && first2 != last2; ++first1, ++first2) 
    {
...
// 重载版本使用函数对象 comp 代替比较操作
template <class InputIterator1, class InputIterator2, class Compred>
pair<InputIterator1, InputIterator2> mismatch(InputIterator1 first1, InputIterator1 last1,InputIterator2 first2, Compred comp) 
{
